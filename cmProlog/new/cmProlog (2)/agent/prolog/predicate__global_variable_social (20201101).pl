...
:- nb_setval(predicate__empty_hand_intersectPer_threshold, 0.05).				%empty_hand
:- nb_setval(predicate__overlap_hand_intersectPer_threshold, 0.05).				%overlap_hand
...
:- nb_setval(predicate__joint_check_joint_angle_threshold, -15).				%joint_check %10 for gazebo 15 for vrep
