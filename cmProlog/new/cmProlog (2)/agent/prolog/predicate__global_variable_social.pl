...
:- nb_linkval(predicate__empty_hand_intersectPer_threshold, 0.05).				%empty_hand
:- nb_linkval(predicate__overlap_hand_intersectPer_threshold, 0.05).				%overlap_hand
...
:- nb_linkval(predicate__joint_check_joint_angle_threshold, -15).				%joint_check %10 for gazebo 15 for vrep
