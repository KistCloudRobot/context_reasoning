...
:- asserta(library_directory('/home/ailab/catkin_ws2/src/socialrobot/src/socialrobot_knowledge/cmProlog/knowrob_library')).
:- asserta(library_directory('/home/ailab/catkin_ws2/src/socialrobot/src/socialrobot_knowledge/cmProlog/agent')).
:- asserta(library_directory('/home/ailab/catkin_ws2/src/socialrobot/src/socialrobot_knowledge/cmProlog/matrix')).
...
:- use_module(library('prolog/predicate_cloud')).
:- use_module(library('prolog/arbi_convenient_service')).
:- use_module(library('prolog/global_variable_social')).
%:- rdf_load(library(owl/cloud/cloud_semantic01)).
:- rdf_load(library(owl/vrep_model_201120)).
:- rdf_load(library(owl/social_object_201120)).
